...
from solutions.torch_modules import SelfAttentionMatrix, CMISelfAttentionMatrix
from solutions.torch_modules import AttentionNeuronLayer, CMIAttentionNeuronLayer
from solutions.torch_modules import VisionAttentionNeuronLayer, CMIVisionAttentionNeuronLayer
        ...
        with torch.no_grad():
            for layer in self.modules_to_learn:
                for p in layer.parameters():
                    params.append(p.cpu().detach().numpy().ravel())
...
@gin.configurable
class CMIPIFCSolution(BaseTorchSolution):
    """CMI Permutation invariant solution."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(CMIPIFCSolution, self).__init__(device=device)
        ...
        self.pi_layer = CMIAttentionNeuronLayer(
            act_dim=act_dim,
    ...
    def _get_action(self, obs):
        ...
        return self.prev_act.cpu().squeeze(0).numpy()
...
@gin.configurable
class CMIPIAttentionAgent(BaseTorchSolution):
    ...
    def __init__(self,
                 ...
                 aa_hidden_dim=16,
                 aa_top_k=10):
        super(CMIPIAttentionAgent, self).__init__(device)
        self.alpha = 0.
        ...
        self.vision_pi_layer = CMIVisionAttentionNeuronLayer(
            act_dim=act_dim,
